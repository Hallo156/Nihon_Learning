...
const kanjiData = [
    ...
    { kanji: '仕', meaning_de: ['dienen', 'Arbeit'], meaning_en: ['serve', 'work'], on: 'シ、ジ', kun: 'つか(える)', romaji: 'shi', romaji_variants: ['ji', 'tsukaeru', 'si'], level: 'A2' },
    { kanji: '事', meaning_de: ['Sache', 'Angelegenheit'], meaning_en: ['thing', 'matter', 'affair'], on: 'ジ、ズ', kun: 'こと', romaji: 'koto', romaji_variants: ['ji', 'zu'], level: 'A2' },
    { kanji: '長', meaning_de: ['lang', 'Chef', 'Leiter'], meaning_en: ['long', 'leader', 'chief'], on: 'チョウ', kun: 'なが(い)', romaji: 'nagai', romaji_variants: ['chou', 'chō'], level: 'A2' },
    { kanji: '高', meaning_de: ['hoch', 'teuer'], meaning_en: ['high', 'tall', 'expensive'], on: 'コウ', kun: 'たか(い)', romaji: 'takai', romaji_variants: ['kou', 'kō'], level: 'A2' },
    { kanji: '安', meaning_de: ['billig', 'günstig', 'guenstig', 'ruhig'], meaning_en: ['cheap', 'inexpensive', 'safe'], on: 'アン', kun: 'やす(い)', romaji: 'yasui', romaji_variants: ['an'], level: 'A2' },
    { kanji: '多', meaning_de: ['viel', 'viele'], meaning_en: ['many', 'much'], on: 'タ', kun: 'おお(い)', romaji: 'ooi', romaji_variants: ['ta'], level: 'A2' },
    { kanji: '少', meaning_de: ['wenig', 'wenige'], meaning_en: ['few', 'little'], on: 'ショウ', kun: 'すく(ない)、すこ(し)', romaji: 'sukunai', romaji_variants: ['shou', 'sukoshi', 'shō'], level: 'A2' },
    ...
    { kanji: '政', meaning_de: ['Politik', 'Regierung'], meaning_en: ['politics', 'government'], on: 'セイ、ショウ', kun: 'まつりごと', romaji: 'sei', romaji_variants: ['shou', 'matsurigoto', 'shō'], level: 'A2' },
    { kanji: '治', meaning_de: ['regieren', 'heilen'], meaning_en: ['govern', 'heal', 'cure'], on: 'チ、ジ', kun: 'おさ(める)、なお(す)', romaji: 'chi', romaji_variants: ['ji', 'osameru', 'naosu'], level: 'A2' },
    { kanji: '問', meaning_de: ['Frage', 'fragen', 'Problem'], meaning_en: ['question', 'ask', 'problem'], on: 'モン', kun: 'と(う)', romaji: 'mon', romaji_variants: ['tou', 'tō'], level: 'A2' },
    { kanji: '題', meaning_de: ['Thema', 'Titel', 'Aufgabe'], meaning_en: ['topic', 'title', 'problem'], on: 'ダイ', kun: '—', romaji: 'dai', romaji_variants: [], level: 'A2' },
    { kanji: '答', meaning_de: ['Antwort', 'antworten'], meaning_en: ['answer', 'reply'], on: 'トウ', kun: 'こた(える)', romaji: 'kotaeru', romaji_variants: ['tou', 'tō'], level: 'A2' },
    { kanji: '説', meaning_de: ['erklären', 'erklaeren', 'Theorie'], meaning_en: ['explain', 'theory'], on: 'セツ、ゼイ', kun: 'と(く)', romaji: 'setsu', romaji_variants: ['zei', 'toku'], level: 'A2' },
    { kanji: '関', meaning_de: ['Beziehung', 'Zusammenhang', 'Schranke'], meaning_en: ['relation', 'connection', 'barrier'], on: 'カン', kun: 'せき、かか(わる)', romaji: 'kan', romaji_variants: ['seki', 'kakawaru'], level: 'A2' },
    { kanji: '係', meaning_de: ['Beziehung', 'Verbindung', 'zuständig', 'zustaendig'], meaning_en: ['relation', 'connection', 'in charge'], on: 'ケイ', kun: 'かか(り)', romaji: 'kei', romaji_variants: ['kakari'], level: 'A2' },
    { kanji: '決', meaning_de: ['entscheiden', 'bestimmen'], meaning_en: ['decide', 'determine'], on: 'ケツ', kun: 'き(める)', romaji: 'kimeru', romaji_variants: ['ketsu'], level: 'A2' },
    { kanji: '定', meaning_de: ['festlegen', 'bestimmen', 'Regel'], meaning_en: ['fix', 'determine', 'rule'], on: 'テイ、ジョウ', kun: 'さだ(める)', romaji: 'tei', romaji_variants: ['jou', 'sadameru', 'jō'], level: 'A2' },
    { kanji: '変', meaning_de: ['ändern', 'aendern', 'seltsam', 'verändern'], meaning_en: ['change', 'strange', 'unusual'], on: 'ヘン', kun: 'か(わる)、か(える)', romaji: 'hen', romaji_variants: ['kawaru', 'kaeru'], level: 'A2' },
    { kanji: '特', meaning_de: ['besonders', 'speziell'], meaning_en: ['special', 'particular'], on: 'トク', kun: '—', romaji: 'toku', romaji_variants: [], level: 'A2' },
    { kanji: '別', meaning_de: ['anders', 'besonders', 'Unterschied', 'Trennung'], meaning_en: ['different', 'special', 'separate'], on: 'ベツ', kun: 'わか(れる)', romaji: 'betsu', romaji_variants: ['wakareru'], level: 'A2' }
];
