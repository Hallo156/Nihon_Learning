...
const simulationDialogs = {
    ...
    */
    furni2: [
        ...
        { type: 'blank', speaker: 'ten',
          before: '', after: 'ようびはいかがですか？',
          before_en: '', after_en: 'day, would that work?',
          de: 'Wie wäre es mit Donnerstag?',
          en: 'How about Thursday?',
          correct: ['もく', 'moku', 'もくよう', 'mokuyou'],
